...
<!-- Login Background -->
        <div id="login-background">
            ...
            <img src="admin_resources/img/placeholders/headers/lock_header.jpg" alt="Login Background" class="animation-pulseSlow">
        </div>
        ...
        <div id="login-container" class="animation-fadeIn">
            ...
            <div class="login-title text-center">
                <h1><i class="gi gi-flash"></i> <strong>ProUI</strong><br><small>Please <strong>{{ __('Login') }}</strong> or <strong>Register</strong></small></h1>
            </div>
            <!-- END Login Title -->
            ...
            <div class="block push-bit">
                <!-- Login Form -->
                <form action="{{ route('login') }}" method="POST" aria-label="{{ __('Login') }}" id="form-login" class="form-horizontal form-bordered form-control-borderless">
                    @csrf
                ...
                <form action="login.html#reminder" method="post" id="form-reminder" class="form-horizontal form-bordered form-control-borderless display-none">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12 text-center">
                            <small>Did you remember your password?</small> <a href="{{ route('password.request') }} id="link-reminder"><small>Login</small></a>
                        </div>
                    </div>
                </form>
                <!-- END Reminder Form -->
